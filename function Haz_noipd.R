##########################################################################################
##========================================================================================
## START OF HAZ_NOIPD FUNCTION
##========================================================================================
##########################################################################################

##========================================================================================
## THE MAIN REASON THIS FUNCTION HAS BEEN INCLUDED IS TO HELP ADDRESS A WARNING MESSAGE
## WITH THE Markov_noipd OR semiMarkov_noipd FUNCTIONS, IF IT OCCURS (SEE README FILE). 
## IT DISPLAYS CUMULATIVE HAZARDS, FOR EACH TRANSITION, FOR EACH TIMEPOINT IN THE SEQUENCE
## GENERATED BY THE GIVEN ttend  AND ttinc ARGUMENTS. WITH THIS, CONSECUTIVE TIMEPOINTS
## WHERE THE DIFFERENCE IN CUMULATIVE HAZARDS IS NOT BELOW ONE, CAUSING THE WARNING 
## MESSAGE IN THE semiMarkov OR semiMarkov_noipd FUNCTION, CAN BE IDENTIFIED. THE alt1end 
## AND/OR alt2beg ARGUMENTS, AND THEIR ASSOCIATED ARGUMENTS, CAN THEN BE VARIED AND THE 
## CUMULATIVE HAZARD INCREMENTS BETWEEN SUCCESSIVE TIMEPOINTS CHECKED UNTIL THEY ARE ALL 
## BELOW ONE.
